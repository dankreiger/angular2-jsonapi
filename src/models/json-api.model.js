...
var JsonApiModel = /** @class */ (function () {
    ...
    JsonApiModel.prototype.parseHasOne = function (data, included, level) {
    ...
    JsonApiModel.prototype.getHasOneRelationship = function (modelType, data, included, typeName, level) {
        var relationshipData = find_1.default(included, { id: data.id, type: typeName });
        if (relationshipData) {
