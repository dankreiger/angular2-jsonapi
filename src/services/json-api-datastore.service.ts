...
export class JsonApiDatastore {
    ...
    query<T extends JsonApiModel>(modelType: ModelType<T>,
                                  params?: any,
                                  headers?: Headers,
    ...
    findAll<T extends JsonApiModel>(modelType: ModelType<T>,
                                    params?: any,
                                    headers?: Headers,
    ...
    findRecord<T extends JsonApiModel>(modelType: ModelType<T>,
                                       id: string,
                                       params?: any,
                                       headers?: Headers,
                                       customUrl?: string): Observable<T> {
    ...
    saveRecord<T extends JsonApiModel>(attributesMetadata: any,
                                       model: T,
                                       params?: any,
                                       headers?: Headers,
                                       customUrl?: string): Observable<T> {
    ...
    deleteRecord<T extends JsonApiModel>(modelType: ModelType<T>,
                                         id: string,
                                         headers?: Headers,
    ...
    private buildUrl<T extends JsonApiModel>(modelType: ModelType<T>,
                                             params?: any,
                                             id?: string,
    ...
    private getRelationships<T extends JsonApiModel>(model: T): any {
    ...
    private transformRelationshipPropertyNamesToSerializedNames<T extends JsonApiModel>(model: T) {
        const relationships: any = this.getRelationships(model);
